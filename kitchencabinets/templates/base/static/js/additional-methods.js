...
}, "A valid number with optional two decimal please");

jQuery.validator.addMethod("exactlength", function(value, element, param) {
	 return this.optional(element) || value.length < param;
}, "Please enter maximum {0} characters.");
...
/**
 * Added by toobler
 * matches US zipcode format
 *
 *  => /(^\d{5}$)|(^\d{5}-\d{4}$)/ (use this)
 *  
 * 94105-0011 or
 * 94105 or
 *
...
jQuery.validator.addMethod("zipUS", function(value, element, param) {
	return value.match(/^\d{5}(-\d{4})?$/);
}, "Please specify a valid us zipcode.");


jQuery.validator.addMethod("letterswithbasic", function(value, element) {
...
}, jQuery.format("Please select a valid image."));

jQuery.validator.addMethod('selectNone',function(value, element) {
	
        return this.optional(element) ||(value.indexOf("Select Business") == 0);
}, jQuery.format("Please select an option"));